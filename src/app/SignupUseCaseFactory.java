...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createUserClearUseCase(clearUserDataAccessObject);
    ...
    private static ClearController createUserClearUseCase(ClearUserDataAccessInterface clearUserDataAccessObject){
        ClearInteractor clearInteractor = new ClearInteractor(clearUserDataAccessObject);
